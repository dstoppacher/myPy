...
def EAGLE_HDF5_filestruct(catname,
                            snapid,
                            subdirid=False,
                            path_to_directory=False):  

    """description form Yetli send with email as Catalogue_Galaxies_Doris.hdf5
    
        Yetli provided the following propeties from EAGLE for the target selection of extented galaxies (D/T>0.65 + 20% largest in reff --> see
                                                                                                     catalog from Patricia!)
    
    
        #dict_keys()
        ['Dhalo', 'jhahlo', 'LastMajorMerger', 'LastMinortMerger',
         'MHII_G30', 'MHII_G60', 'MHII_K30', 'MHII_K60', 'MHI_G30', 'MHI_G60', 'MHI_K30', 'MHI_K60',
        'Mstar_30kpc', 'environment',
        'g_fil', 'i_fil','r_fil', 'u_fil','z_fil']
    ...
    SAM_hdf5_filestruct_map[catname+'_haloid']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/Dhalo'
    SAM_hdf5_filestruct_map[catname+'_hostid']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/jhahlo' 
    SAM_hdf5_filestruct_map[catname+'_lastMinorM']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LastMinortMerger'
    SAM_hdf5_filestruct_map[catname+'_lastMajorM']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LastMajorMerger'
    
    SAM_hdf5_filestruct_map[catname+'_Mgas_HI_30kpc_GK11']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHI_G30'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HII_30kpc_GK11']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHII_G30'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HI_30kpc_K13']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHI_K30'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HII_30kpc_K13']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHII_K30'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HI_60kpc_GK11']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHI_G60'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HII_60kpc_GK11']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHII_G60'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HI_60kpc_K13']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHI_K60'
    SAM_hdf5_filestruct_map[catname+'_Mgas_HII_60kpc_K13']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MHII_K60'
    
    SAM_hdf5_filestruct_map[catname+'_mstar_30kpc']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/Mstar_30kpc'
    SAM_hdf5_filestruct_map[catname+'_envr']                 = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/environment'

    SAM_hdf5_filestruct_map[catname+'_MAB_total_u']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/u_fil'
    SAM_hdf5_filestruct_map[catname+'_MAB_total_g']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/g_fil'
    SAM_hdf5_filestruct_map[catname+'_MAB_total_r']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/r_fil'
...
def EAGLE_ev_HDF5_filestruct(catname,
                            snapid,
                            subdirid=False,
                            path_to_directory=False):  

    """description form Ben Rouse generated by Yetli send with email (April 2023) as Catalogue_Galaxies_27March2023_ev.hdf5
    
    
        f.keys()
        <KeysViewHDF5 ['InnerVoidGals', 'OuterVoidGals', 'SkeletonGals', 'WallGals']>

            <HDF5 group "/InnerVoidGals" (24 members)>
            <HDF5 group "/OuterVoidGals" (24 members)>
            <HDF5 group "/SkeletonGals" (24 members)>
            <HDF5 group "/WallGals" (24 members)>

            InnerVoidGals <HDF5 dataset "Mgas30kpc": shape (492,), type "<f8">
            OuterVoidGals <HDF5 dataset "Mgas30kpc": shape (460,), type "<f8">
            SkeletonGals <HDF5 dataset "Mgas30kpc": shape (1208,), type "<f8">
            WallGals <HDF5 dataset "Mgas30kpc": shape (3082,), type "<f8">
            
            Total 5242
     
            WallGals content:
                
            17 properties at z=0
                <HDF5 dataset "DtoT": shape (3082,), type "<f8">
                <HDF5 dataset "Group": shape (3082,), type "<f8">
                <HDF5 dataset "LastMajorMerger": shape (3082,), type "<f8">
                <HDF5 dataset "LastMinorMerger": shape (3082,), type "<f8">
                <HDF5 dataset "Lbolometric": shape (3082,), type "<f8">
                <HDF5 dataset "M200": shape (3082,), type "<f8">
                <HDF5 dataset "MBH": shape (3082,), type "<f8">
                <HDF5 dataset "Mdot": shape (3082,), type "<f8">
                <HDF5 dataset "MetallicityGradients": shape (3082,), type "<f8">
                <HDF5 dataset "Mgas30kpc": shape (3082,), type "<f8">
                <HDF5 dataset "Mstar30kpc": shape (3082,), type "<f8">
                <HDF5 dataset "OtoH30": shape (3082,), type "<f8">
                <HDF5 dataset "Rvoid": shape (3082,), type "<f8">
                <HDF5 dataset "SFR30kpc": shape (3082,), type "<f8">
                <HDF5 dataset "Subgroup": shape (3082,), type "<f8">
                <HDF5 dataset "TimeGalaxy50": shape (3082,), type "<f8">
                <HDF5 dataset "TimeGalaxy70": shape (3082,), type "<f8">
            
            7 properties evolution 0: Snapid 28, 28: Snapid 0
                <HDF5 dataset "M200_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "SFR30_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "Mstar_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "Mdot_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "Mgas_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "Mgassf_ev": shape (3082, 29), type "<f8">
                <HDF5 dataset "BHmass_ev": shape (3082, 29), type "<f8">
            
            ['BHmass_ev', 'DtoT', 'Group', 'LastMajorMerger', 'LastMinorMerger', 'Lbolometric', 'M200', 'M200_ev',\
             'MBH', 'Mdot', 'Mdot_ev', 'MetallicityGradients', 'Mgas30kpc', 'Mgas_ev', 'Mgassf_ev', 'Mstar30kpc', 'Mstar_ev',\
             'OtoH30', 'Rvoid', 'SFR30_ev', 'SFR30kpc', 'Subgroup', 'TimeGalaxy50', 'TimeGalaxy70']
    ...
    SAM_hdf5_filestruct_map[catname+'_myenv']  = {0: 'InnerVoidGals', 1: 'OuterVoidGals', 2: 'WallGals', 3: 'SkeletonGals'}

    for k, item in enumerate(SAM_hdf5_filestruct_map[catname+'_myenv'].values()):        

        SAM_hdf5_filestruct_map[catname+'_'+item+'_haloid']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Group'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_hostid']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Subgroup'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_lastMinorM']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/LastMinorMerger'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_lastMajorM']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/LastMajorMerger'    
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mstar_30kpc']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mstar30kpc'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mbh']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/MBH'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mhalo_200c']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/M200'  
        SAM_hdf5_filestruct_map[catname+'_'+item+'_rVoid']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Rvoid'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_DtoVoidCent']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/DtoVoid'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mgas_30kpc']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mgas30kpc'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_OH_gas_30kpc']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/OtoH30'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_t50_stars']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/TimeGalaxy50'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_t70_stars']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/TimeGalaxy70'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_sfr_30kpc']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/SFR30kpc'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_L_bolo']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Lbolometric'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_z_grad']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/MetallicityGradients'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_bh_acc_rate']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mdot'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_DvT_stars']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/DtoT'
             
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mgas_SF_30kpc_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mgassf_ev'
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mhalo_200c_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/M200_ev'               
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mstar_30kpc_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mstar_ev'               
        SAM_hdf5_filestruct_map[catname+'_'+item+'_sfr_30kpc_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/SFR30_ev' 
        SAM_hdf5_filestruct_map[catname+'_'+item+'_bh_acc_rate_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mdot_ev'         
        SAM_hdf5_filestruct_map[catname+'_'+item+'_mgas_30kpc_ev']               = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/'+item+'/Mgas_ev' 
...
def Galcticus_HDF5_filestruct(
    ...
    SAM_hdf5_filestruct_map[catname+'_regionName']                   = ''
    ...
    SAM_hdf5_filestruct_map[catname+'_fbar']     = ''
    SAM_hdf5_filestruct_map[catname+'_Tcons']     = ''
    SAM_hdf5_filestruct_map[catname+'_BvT']     = ''
    ...
    SAM_hdf5_filestruct_map[catname+'_bheff']     = ''     
    ...
    SAM_hdf5_filestruct_map[catname+'_angM_hotHalo']= SAM_hdf5_filestruct_map[catname+'_path_to_data']+snapid+'/nodeData/hotHaloAngularMomentum'
    SAM_hdf5_filestruct_map[catname+'_angM_outflowHotHalo']= SAM_hdf5_filestruct_map[catname+'_path_to_data']+snapid+'/nodeData/hotHaloOutflowedAngularMomentum'
    ...
    SAM_hdf5_filestruct_map[catname+'_rhotHalo']            = SAM_hdf5_filestruct_map[catname+'_path_to_data']+snapid+'/nodeData/hotHaloOuterRadius' 
    ...
    SAM_hdf5_filestruct_map[catname+'_Mzhot_outflowHalo']           = SAM_hdf5_filestruct_map[catname+'_path_to_data']+snapid+'/nodeData/hotHaloOutflowedAbundancesMetals'   
...
def MDGalaxies_SkiesANDUniverses(catname,
                                snapid,
                                subdirid=1,
                                path_to_directory=False):
    ...
    SAM_hdf5_filestruct_map[catname+'_hostid']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/HostHaloID'    
    ...
    SAM_hdf5_filestruct_map[catname+'_mstar_disk'] = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MstarDisk'
    SAM_hdf5_filestruct_map[catname+'_mstar_spheroid'] = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MstarSpheroid'
    SAM_hdf5_filestruct_map[catname+'_mcold_disk']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/McoldDisk'
    SAM_hdf5_filestruct_map[catname+'_mhot']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/Mhot'
    SAM_hdf5_filestruct_map[catname+'_mbh']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/Mbh'

    SAM_hdf5_filestruct_map[catname+'_sfr_spheroid']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/SFRspheroid'    
    SAM_hdf5_filestruct_map[catname+'_sfr_disk']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/SFRdisk'
    
    SAM_hdf5_filestruct_map[catname+'_mhalo']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/HaloMass'

    SAM_hdf5_filestruct_map[catname+'_Mzgas_disk']     = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MZgasDisk'
    SAM_hdf5_filestruct_map[catname+'_Mzstar_spheroid']     = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MZ_stars_bulge'
    SAM_hdf5_filestruct_map[catname+'_Mzstar_disk']     = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MZstarDisk'
    SAM_hdf5_filestruct_map[catname+'_Mzhot_halo']     = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MZ_hot_halo'    
     
    SAM_hdf5_filestruct_map[catname+'_L_SDSS_dA_total_u']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LstarSDSSu'
    SAM_hdf5_filestruct_map[catname+'_L_SDSS_dA_total_g']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LstarSDSSg'
    SAM_hdf5_filestruct_map[catname+'_L_SDSS_dA_total_r']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LstarSDSSr'
    SAM_hdf5_filestruct_map[catname+'_L_SDSS_dA_total_i']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LstarSDSSi'
    SAM_hdf5_filestruct_map[catname+'_L_SDSS_dA_total_z']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/LstarSDSSz'

    SAM_hdf5_filestruct_map[catname+'_rdisk']              = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/rdisk'
    SAM_hdf5_filestruct_map[catname+'_rbulge']             = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/rbulge'
    SAM_hdf5_filestruct_map[catname+'_rhalf_mass']         = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/rhalf_mass'
    
    SAM_hdf5_filestruct_map[catname+'_SpinParameter']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/SpinParameter'  

    SAM_hdf5_filestruct_map[catname+'_mcold_spheroid']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/McoldSpheroid'
    SAM_hdf5_filestruct_map[catname+'_Mzgas_spheroid']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/MZgasSpheroid'
...
#        i+=1  
    ...
    if catname.find('sub')!=-1:
        ...
        SAM_hdf5_filestruct_map[catname+'_GalaxyStaticID']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/GalaxyStaticID'
        SAM_hdf5_filestruct_map[catname+'_ForestID']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/ForestID'
       
        SAM_hdf5_filestruct_map[catname+'_OH_gas_disk_bulge']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/OH_gas_disk_bulge'
        SAM_hdf5_filestruct_map[catname+'_FeH_hotHalo']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/FeH_hot_halo' 
        SAM_hdf5_filestruct_map[catname+'_FeH_stars']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/FeH_stars' 
...
def SAGE_HDF5_filestruct(catname,
    ...
    SAM_hdf5_filestruct_map[catname+'_lastMinorM']            = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/TimeOfLastMinorMerger'
    SAM_hdf5_filestruct_map[catname+'_lastMajorM']            = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/TimeOfLastMajorMerger'
...
def CHOLLA_50Mpc_PARTICLE_HDF5_filestruct(catname,
                                snapid,
                                subdirid=1,
                                path_to_directory=False): 
    ...
    SAM_hdf5_filestruct_map[catname+'_z_pos']      = 'pos_z'
    ...
    SAM_hdf5_filestruct_map[catname+'_HeII_density']    = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/HeII_density'
    SAM_hdf5_filestruct_map[catname+'_HeIII_density']   = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/HeIII_density'
    SAM_hdf5_filestruct_map[catname+'_x_ang']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/momentum_x'
    SAM_hdf5_filestruct_map[catname+'_y_ang']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/momentum_y'
    SAM_hdf5_filestruct_map[catname+'_z_ang']      = SAM_hdf5_filestruct_map[catname+'_path_to_data']+'/momentum_z'
    
    return SAM_hdf5_filestruct_map

def CHOLLA_50Mpc_ROCKSTAR_filestruct(catname,
                                snapid,
                                subdirid=1,
                                path_to_directory=False): 
