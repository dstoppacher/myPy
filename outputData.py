...
#                    myConfig.plot_config_array['error_bars_y_sub']='no'
                ...
                add_tick_params(key_sub1, 'both', 'minor', length=minor_ticks_lenght, width=minor_ticks_width)
                ...
                try:
                    if myConfig.plot_config_array['add_axis_sub']=='yes' and myConfig.plot_config_array['add_axis_sub_which_ref'+str(j)]=='True':
                        ...
                        add_axis(add_subplot, 'key_add_sub'+str(j), key0, count_add_axis, int(myConfig.plot_config_array['add_which_col_sub']), int(myConfig.plot_config_array['add_axis_steps_sub'])) 
                except:
            ...
            def add_axis(add_which_axis, data2add, key_add, parent_axis, axis_id, count, col, steps):
                ...
                if add_which_axis=='add_x':
                    ...
                    xmin_add=min(data_add_x)
                    xmax_add=max(data_add_x)                    
                    ...
                    key_add_y.spines["right"].set_position(("axes", 1+0.16*count))
                    ...
                    key_add_y.plot(data2add[:,0], data_add_y,  ls=' ', marker=' ')


                if add_which_axis=='add_x':               
                    key_add_x.set_xlabel(myConfig.plot_config_array['title_add_x'+str(axis_id)], color='k', fontsize=int(myConfig.plot_config_array['axis_label_fontsize'])-8,labelpad=10)
                    key_add_x.set_xlim(xmin_add,xmax_add)
                else:
                    key_add_y.set_ylabel(myConfig.plot_config_array['title_add_y'+str(axis_id)], color='k', fontsize=int(myConfig.plot_config_array['axis_label_fontsize'])-8, rotation=270, labelpad=20+count*8)
                ...
                if myConfig.plot_config_array['add_axis_plot_exact_ticks']=='True':
                    ...
                    while a<data2add[:,0].size:
                        if add_which_axis=='add_x':                    
                            ...
                            #plt.axvline(x=float("{0:.2f}".format(np.round(mydata[a,c*data_block_offset+int(myConfig.plot_config_array['add_which_col'])],1))), linewidth=1, color=mycolor_code, ls=mylinestyle)
                            ...
                            ticks+=[float("{0:.2f}".format(np.round(data_add_y[a],2)))]
                            #plt.axvline(x=float("{0:.2f}".format(np.round(mydata[a,c*data_block_offset+int(myConfig.plot_config_array['add_which_col'])],1))), linewidth=1, color=mycolor_code, ls=mylinestyle)
                            #plt.axvline(x=float("{0:.2f}".format(np.round(mydata[a,c*data_block_offset],1))), linewidth=1, color=mycolor_code, ls=mylinestyle)
                            data+=[float("{0:.2f}".format(np.round(data2add[a,1],2)))]                        
                            a+=steps
                ...
                if add_which_axis=='add_x':                
                    ...
                    if myConfig.plot_config_array['log_scale_add_x']=='yes':
                        key_add_x.set_xscale('log')
                    else:
                        key_add_x.set_xscale('linear')
                    if ticks!=[]:
                    ...
                    if myConfig.plot_config_array['add_axis_plot_exact_ticks']=='True':
                        add_tick_params(key_add_x, 'both', 'minor', bottom='off', top='off', length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)
                        add_tick_params(key_add_x, 'both', 'major', bottom='off', top='on', length=major_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6) 

                    else:
                        add_tick_params(key_add_x, 'both', 'minor', isadd_x=True, xmin_add=xmin_add, xmax_add=xmax_add, bottom='off', top='off', length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)
                        add_tick_params(key_add_x, 'both', 'major', isadd_x=True, xmin_add=xmin_add, xmax_add=xmax_add, bottom='off', top='on', length=major_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6) 

                
                else:
                    key_add_y.set_yticks(data)
                    if myConfig.plot_config_array['log_scale_add_y']=='yes':
                        key_add_y.set_yscale('log')
                    else:
                    ...
                    if myConfig.plot_config_array['add_axis_plot_exact_ticks']=='True':
                        add_tick_params(key_add_y, 'both', 'minor', left='off', right='off', length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)
                        add_tick_params(key_add_y, 'both', 'major', left='off', right='on', length=major_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)
                       
                    else:
                        add_tick_params(key_add_y, 'both', 'minor', isadd_y=True, ymin_add=ymin_add, ymax_add=ymax_add, left='off', right='off', length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)
                        add_tick_params(key_add_y, 'both', 'major', isadd_y=True, ymin_add=ymin_add, ymax_add=ymax_add, left='off', right='on', length=major_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), set_visible=True, label_size_offset=8, pad=6)

                  
                  
    
            def add_marker(key, ax, x_data, y_data, marker, color, ls, mfc, mylw, size=float(myConfig.plot_config_array['markersize']), width=float(myConfig.plot_config_array['mymarkeredgewidth'])):
            ...
            def add_errorbars(ax, errorbars, x_bar, y_bar, filled_between, x_data, y_data, xerr_data1, yerr_data1, xerr_data2=[], yerr_data2=[], color='k', fcolor='k', alpha=0.3):               
            ...
            def add_tick_params(ax, which_axis, which_ticks, length=12, width=float(myConfig.plot_config_array['myframe_lw']), bottom='on', top='on', right='on', left='on', pad=10, set_visible=False, label_size_offset=0, isadd_x=False, xmin_add=None, xmax_add=None, isadd_y=False, ymin_add=None, ymax_add=None):
                ...
                if myConfig.plot_config_array['log_scale_x']=='yes' and isadd_x==False:
                    ax.set_xscale('log')         
#                    
                if myConfig.plot_config_array['log_scale_y']=='yes' and isadd_y==False:
                    ax.set_yscale('log')                           
            ...
            def histo_number_density(data_x,
                ...
                axis = axHistx.hist(data_x, bins=binsx, alpha=myalpha, edgecolor=mycolor, facecolor=myfacecolor, ls=myls, lw=2.5, normed=0, weights=myhisto_weights)
                ...
                axHisty.hist(data_y, bins=binsy, orientation='horizontal', alpha=myalpha, edgecolor=mycolor, facecolor=myfacecolor, ls=myls, lw=2.5, normed=False, weights=myhisto_weights)
            ...
            #CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR CONTOUR                    
                ...
                if len(mydata['name'+str(j)+'_data'][mydata['col_name_x']])>50e6:
                ...
                elif len(mydata['name'+str(j)+'_data'][mydata['col_name_x']])>5e6:
...
#START START START START START START START START START START START START START START START START START START START START START START START START START START START START
            ...
            add_plot_pars=[add_plot_par1,add_plot_par2,add_plot_par3,add_plot_par4,add_plot_par5,add_plot_par6,add_plot_par7,add_plot_par8,add_plot_par9,add_plot_par10]
            mykeyword_changes=[mykeyword_change1,mykeyword_change2,mykeyword_change3,mykeyword_change4,mykeyword_change5,mykeyword_change6,mykeyword_change7,mykeyword_change8,mykeyword_change9,mykeyword_change10]                    
...
#CHOOSE A PLOT TYPE OR GO TO DEFAULT Main() 
            ...
            for f in [prefix+'x_range_min', prefix+'x_range_max', prefix+'y_range_min', prefix+'y_range_max']:
            ...
            if myPlottypeTable[str(i)]=='default' or myPlottypeTable[str(i)]=='barplot':
                ...
                add_tick_params(myax, 'both', 'minor', length=minor_ticks_lenght, width=minor_ticks_width, set_visible=True)
                add_tick_params(myax, 'both', 'major', length=major_ticks_lenght, width=major_ticks_width, set_visible=True)
...
#ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS ADD-AXIS                
            ...
            while p<loops:
                if add_xaxisTable[str(p)]=='yes':
                    add_axis('add_x', mydata[:,data_block_offset*p : data_block_offset*p + data_block_offset], 'key_add'+str(p), key0, p, count_add_axis_x, int(myConfig.plot_config_array['add_which_col_x']), int(myConfig.plot_config_array['add_axis_steps_x']))   
                    count_add_axis_x+=1
...
#                    myConfig.plot_config_array['filled_between'] = 'False'                    
                ...
                if myPlottypeTable[str(i)]=='default':
                    ...
                    if mymarker_code!=' ' and mymarker_code!='no':
                        key2 = add_marker(key2, 
                                          key1, 
                                          mydata[:,i*data_block_offset],mydata[:,i*data_block_offset+1], 
                                          mymarker_code, 
                                          mycolor_code, 
                                          mylinestyle, 
                                          mymarkerfacecolor, 
                ...
                add_tick_params(key1, 'both', 'minor', length=minor_ticks_lenght, width=minor_ticks_width, set_visible=False)
                                
                if myConfig.plot_config_array['add_axis']=='yes':
                    add_tick_params(key1, 'both', 'major', length=0, width=major_ticks_width, set_visible=False)
                else:
                    add_tick_params(key1, 'both', 'major', length=major_ticks_lenght, width=major_ticks_width, set_visible=False)
...
#FURTHER SPECIFICATIONS
            ...
            if myConfig.plot_config_array[prefix+'hline_ypos']!='False':
                ...
                while a<len(my_hlines):
                    plt.axhline(y=float(my_hlines[a]), xmin=-100, xmax=100, color='k', ls='--', lw=2.0, zorder=30)
                    a+=1                

            if myConfig.plot_config_array[prefix+'vline_xpos']!='False':
                my_vlines=mL.multicolTestAlgorithm(myConfig.plot_config_array[prefix+'vline_ypos'])
                a=0
                while a<len(my_hlines):
                    plt.axvline(x=float(my_vlines[a]), ymin=-100, ymax=100, color='k', ls='--', lw=2.0, zorder=30) 
                    a+=1                     
            ...
            if myConfig.plot_config_array['yticks']!='':
                ...
                myax.tick_params(axis='y', which='minor', bottom='off', top='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), direction='in', width=float(myConfig.plot_config_array['myframe_lw']), zorder=20)          
                
                if myConfig.plot_config_array['yticks_minor']=='default':
                     myax.tick_params(axis='y', which='minor', top='on', bottom='on', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20)                    
            ...
            if myConfig.plot_config_array['xticks']!='':
                ...
                myax.tick_params(axis='x', which='minor', bottom='off', top='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), direction='in', width=float(myConfig.plot_config_array['myframe_lw']), zorder=20)          
                
                if myConfig.plot_config_array['xticks_minor']=='default':
                     myax.tick_params(axis='x', which='minor', top='on', bottom='on', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20)                    
                ...
                if myConfig.plot_config_array['add_axis']=='yes':
                    if add_xaxisTable.values()=='yes':
                        print 'here 1487'
                        myax.tick_params(axis='x', which='both', bottom='on', top='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20) 
                        myax.tick_params(axis='x', which='both', bottom='on', top='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20) 

                        myax.tick_params(axis='y', which='both', left='on', right='on', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20) 
                                         
                    elif add_yaxisTable.values()=='yes':
                        print 'here 1491'
                    ...
                    elif add_xaxisTable.values()=='yes' and add_yaxisTable.values()=='yes':
                        print 'here 1496'
                        myax.tick_params(axis='y', which='minor', left='on', right='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20)                    
                        myax.tick_params(axis='y', which='major', left='on', right='off', pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20)                    
            ...
            if myConfig.plot_config_array['minor_ticks_x_space']!='no':
                myax.tick_params(axis='x', which='minor', bottom=myConfig.plot_config_array['minor_ticks_x_set_bottom'], top=myConfig.plot_config_array['minor_ticks_x_set_top'], pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20)          
                minor_x = MultipleLocator(float(myConfig.plot_config_array['minor_ticks_x_space']))
                myax.xaxis.set_minor_locator(minor_x)
                myax.set_zorder(25)
            if myConfig.plot_config_array['minor_ticks_y_space']!='no':
                myax.tick_params(axis='y', which='minor', left=myConfig.plot_config_array['minor_ticks_y_set_left'], right=myConfig.plot_config_array['minor_ticks_y_set_right'], pad=10, labelsize=float(myConfig.plot_config_array['axis_ticks_fontsize']), length=minor_ticks_lenght, width=float(myConfig.plot_config_array['myframe_lw']), direction='in', zorder=20) 
                minor_y = MultipleLocator(float(myConfig.plot_config_array['minor_ticks_y_space']))
                myax.yaxis.set_minor_locator(minor_y)
                myax.set_zorder(25)
            ...
            if myConfig.plot_config_array[prefix+'plot_legend']=='yes':
                ...
                mylegend = fig.legend(axis,
                           ...
                           frameon=myframeon,
                           labelspacing=0.2,
                           handletextpad=float(myConfig.plot_config_array['legend_handletextpad']))
...
#MAIN PLOT
        ...
        if nr_plots_x==1 and nr_plots_y==1:
            ...
            for axis in ['top','bottom','left','right']:
                ax0.spines[axis].set_linewidth(float(myConfig.plot_config_array['myframe_lw'])) 
...
#                                plt.setp(key.get_yticklabels(), visible=False)                       
                    ...
                    try: 
                        key.axhline(y=float(myConfig.plot_config_array[mydata[k]['name']+'hline_ypos']), xmin=-100, xmax=100, color='k', ls='--', lw=2.0, zorder=20)
                        print 'plotted axhline!'
                    except:
                        pass
                    
                    try:
                        key.axvline(x=float(myConfig.plot_config_array[mydata[k]['name']+'vline_xpos']), ymin=-100, ymax=100, color='k', ls='--', lw=2.0, zorder=20)
        ...
        try:
            ...
            elif myConfig.plot_config_array['float_format_y']=='32f':
        ...
        with h5py.File(filename, 'w') as hf:
            ...
            if write_attributes==True:
                try:
                    ...
                    if myconfig_array[catname+'_sample_info']!='full':
                        hf.attrs['ngalRandomSelected'] = myconfig_array[catname+'_ngal_random_sample']
