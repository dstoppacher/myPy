...
#                    
            ...
            def plot_lines_min_max_population(H,X,Y,
                ...
                print('plot line at vertical/horizontal position at the', end='')                   
                if plot_min!=False:
                    print('MINIMUM', end='')
...
#
            ...
            if myPlottypeTable[str(i)]=='default' or myPlottypeTable[str(i)]=='barplot' or myPlottypeTable[str(i)]=='violin':
                ...
                while c<loops:
                    ...
                    print('i:', i, 'c:', c, 'catname:', catname, 'mylegend:', mylegend, 'myls:', mylinestyle, 'mycolor_code:', mycolor_code, 'color_map:', mycolor_map, end='')
        ...
        with h5py.File(filename, 'w') as hf:
            ...
            while i<myconds_array['nr_entries']:
                ...
                if myconds_array[myconds_array['name'+str(i)]+'_exclude']!='yes':
                    ...
                    dset.attrs['colName'] = str(col_name)
