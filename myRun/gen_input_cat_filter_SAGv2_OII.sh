...
set tarsel_code_default = 'OII'

#Choose different catalogues to read!
#+++++++++++++++++++++++++++++++++++++++++++

set tarsel_code_SAG = 'OII'
...
#Galacticus MDPL2 1 Gpc: 79 z=0, 75 z=0.09, 73 z=0.14, 61 z=0.49, 59 z=0.56, 55=0.7, 52=.82, 50 =0.9, 29 z=2.03, 24 z=2.38, min 1 z=8.0
	#for sfr2mstar paper:   79 z=0, 75 z=0.09, 58 z=0.59, 54 z=0.74, 50 z=0.9, 43 z=1.22
#SAG MDPL2 1 Gpc: 		125 z=0,  122 z=0.07, 119 z=0.14, 107 z=0.49, 104 z=0.59, 101=0.7, min 75 z=2.03
	#for sfr2mstar paper:   125 z=0, 122 z=0.07, 104 z=0.59, 101 z=0.7, 95 z=0.94, 89 z=1.22
#SAG cal01 nifty 125: 	107 z=0,  98 z=0.15, min 4 z=7.73
#SAGE 1Gpc v3:
	#for sfr2mstar paper:   0.000 z=0, 0.093 z=0.07, 0.592 z=0.59, 0.742 z=0.74, 0.902 z=0.9, 1.220 z=1.22

if ($HDF5_read_code == 'SAMHDF5' || $HDF5_read_code == 'BINARY_SAGE') then

	if ($SOFTLINK_CODE == A) then
		#OII-paper 
		set MYSNAPS_1Gpc	= '79 75 58 54 50 43'
		...
		#OII-paper 
		#set MYSNAPS_1Gpc	= '0.000 0.930 0.592 0.740 0.901 1.220'
	...
	if ($SOFTLINK_CODE == A) then 
		...
		set MYSNAPS_1Gpc	= '125 122 104 101 95 89 75'
	endif	
endif
...
#only SAG
set Mzgas_spheroid	= 10
set Mzgas_disk		= 11


#only SAG and SAGE
set Mzstar_spheroid	= 12
set Mzstar_disk		= 13
set Mzstar		= 14
set Mzhot_halo		= 99
...
if ($SOFTLINK_CODE == A) then
	...
	set L_SDSS_dA_total_u	= 99
	set L_SDSS_dA_total_g	= 11
	set L_SDSS_dA_total_r	= 12
	set L_SDSS_dA_total_i	= 99
	set L_SDSS_dA_total_z	= 99
	
	set L_RGO_dA_total_B	= 13
	set L_RGO_dA_disk_B	= 99
	set L_RGO_dA_spheroid_B	= 99

	set MAB_dA_total_u	= 99
	set MAB_dA_total_g	= 14
	set MAB_dA_total_r	= 15
	set MAB_dA_total_i	= 99
	set MAB_dA_total_z	= 99

	set Mag_dA_total_B	= 16
	...
	set MAB_dA_total_u	= 22
	set MAB_dA_total_g	= 23
	set MAB_dA_total_r	= 24
	set MAB_dA_total_i	= 25
	set MAB_dA_total_z	= 26
	...
	set OII_cont_3727_ext	= 31
	set OII_cont_3727	= 32
	set OII_cont_3729_ext	= 33
	set OII_cont_3729	= 34
		...
		foreach CATALOG ($key)
			...
			if ($NAME =~ SAG*) then
				...
				if ($NAME =~ SAG_*) then
					...
					#echo 'HERE 1146:' $PATH_TO_SNAPSHOT, $SOFTLINK_TO_DATA$PATH_TO_SNAPSHOT
