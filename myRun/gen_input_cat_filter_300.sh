...
set tarsel_code_Galacticus = 'MD'
set tarsel_code_SAG = 'MD'
set tarsel_code_SAGE = 'MD'
...
#only SAG and SAGE
set mean_age_stars	= 19

#only Galacticus and SAGE		
set spinParameter	= 24
...
#only SAG
set Mzgas_spheroid	= 27
set Mzgas_disk		= 28


#only SAG and SAGE
set Mzstar_spheroid	= 25
set Mzstar_disk		= 26
set Mzstar		= 99
set Mzhot_halo		= 29
...
if ($SOFTLINK_CODE == A) then
	...
	set L_SDSS_dA_total_u	= 30
	set L_SDSS_dA_total_g	= 31
	set L_SDSS_dA_total_r	= 32
	set L_SDSS_dA_total_i	= 33
	set L_SDSS_dA_total_z	= 34

	set MAB_dA_total_u	= 35
	set MAB_dA_total_g	= 36
	set MAB_dA_total_r	= 37
	set MAB_dA_total_i	= 38
	set MAB_dA_total_z	= 39
	...
	set MAB_dA_total_u	= 30
	set MAB_dA_total_g	= 31
	set MAB_dA_total_r	= 32
	set MAB_dA_total_i	= 33
	set MAB_dA_total_z	= 34

	set mstar_IC		= 35
	set rhalf_bulge		= 36
	set rhalf_disk		= 37

else if ($SOFTLINK_CODE == F) then
