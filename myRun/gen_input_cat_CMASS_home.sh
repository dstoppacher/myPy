...
#set tarsel_code_default = 'wis_pca_bc03_DR12'
#set tarsel_code_default = 'gra_kroupa_con09_nodust_DR12'
#set tarsel_code_default = 'gra_kroupa_con09_dust_DR12'
#set tarsel_code_default = 'por_kroupa_mar0609_merged_DR12'

#CMASS 0.55
#set tarsel_code_default = 'wis_DR12v4_compl_sample'
#set tarsel_code_default = 'gra_nodust_DR12v4_compl_sample'
set tarsel_code_default = 'por_merged_DR12v4_compl_sample'
set tarsel_code_default = 'por_SF_DR12v4_compl_sample'
set tarsel_code_default = 'por_PS_DR12v4_compl_sample'

#CMASS 0.43 - 0.75
#set tarsel_code_default = '0.75_wis_DR12v4_compl_sample'
#set tarsel_code_default = '0.75_gra_nodust_DR12v4_compl_sample'
#set tarsel_code_default = '0.75_por_merged_DR12v4_compl_sample'
#set tarsel_code_default = '0.75_por_SF_DR12v4_compl_sample'
#set tarsel_code_default = '0.75_por_PS_DR12v4_compl_sample'
...
set tarsel_code_SAG = 'v3'$add_tarsel_code
set tarsel_code_SAGE = 'v3_new'$add_tarsel_code
...
#set output_filename_code_default = 'wis_pca_bc03_DR12'
#set output_filename_code_default = 'z_0.55_gra_kroupa_con09_nodust_DR12'
#set output_filename_code_default = 'gra_kroupa_con09_dust_DR12'
#set output_filename_code_default = 'por_kroupa_mar0609_merged_DR12'
#set output_filename_code_default = 'full_mags_cut'
#set output_filename_code_default = 'wis_DR12v4_compl_sample'
...
#Wisconsin
#set MYSNAPS_default			= 'bc03-DR12-boss'
#Granada no dust
...
#set fits_map_names	= 'DEC;RA;Z;LOGMASS;LOGMASS_MEDIAN;LOGMASS_ERR;AGE;SSFR;SSFR_MIN;SSFR_MAX;MAGSCALED;MAGSCALED1;MAGSCALED2;MAGSCALED3;MAGSCALED4;CMODELABSMAG;CMODELABSMAG1;CMODELABSMAG2;CMODELABSMAG3;CMODELABSMAG4;KE;KE1;KE2;KE3;KE4'
#set fits_map_names_mapping = 'DEC;RA;Z;mstar;mstar_5000;mstar_err;age;ssfr;ssfr_min;ssfr_max;mAB_total_u;mAB_total_g;mAB_total_r;mAB_total_i;mAB_total_z;MAB_total_u;MAB_total_g;MAB_total_r;MAB_total_i;MAB_total_z;kcorr_u;kcorr_g;kcorr_r;kcorr_i;kcorr_z'
#Granada DR12 BOSS dust
#set fits_map_names_mapping = 'DEC;RA;Z;mstar;mstar_5000;mstar_err;age;ssfr;ssfr_min;ssfr_max;mAB_dA_total_u;mAB_dA_total_g;mAB_dA_total_r;mAB_dA_total_i;mAB_dA_total_z;MAB_dA_total_u;MAB_dA_total_g;MAB_dA_total_r;MAB_dA_total_i;MAB_dA_total_z;kcorr_u;kcorr_g;kcorr_r;kcorr_i;kcorr_z'

#Portsmouth 
#set fits_map_names	= 'DEC;RA;Z;LOGMASS;MINLOGMASS;MAXLOGMASS;AGE;SFR;MINSFR;MAXSFR;MAGSCALED;MAGSCALED1;MAGSCALED2;MAGSCALED3;MAGSCALED4;MAGSCALED_ERR;MAGSCALED_ERR1;MAGSCALED_ERR2;MAGSCALED_ERR3;MAGSCALED_ERR4;ABSMAGK'
#set fits_map_names_mapping = 'DEC;RA;Z;mstar;mstar_min;mstar_max;age;sfr;sfr_min;sfr_max;mAB_dA_total_u;mAB_dA_total_g;mAB_dA_total_r;mAB_dA_total_i;mAB_dA_total_z;mAB_dA_total_err_u;mAB_dA_total_err_g;mAB_dA_total_err_r;mAB_dA_total_err_i;mAB_dA_total_err_z;Mag_dA_total_K'
...
#DR13v4 spall from Sergio/Antonio
set fits_map_names	= 'DEC;RA;Z;MSTELLAR_WISC'
...
if ($tarsel_code_default =~ 'rwis'*) then
...
else if ($tarsel_code_default =~ 'rgra'*) then
	#Observational data
	set DEC			= 25
	set RA			= 26
	set Z			= 4
	...
	if ($tarsel_code_default =~ *'rnodust'*) then
		set mAB_total_u	= 20
		set mAB_total_g	= 21
		set mAB_total_r	= 22
		set mAB_total_i	= 0
		...
		set mAB_total_cut_r_i	= 1
		set mAB_total_cut_dmesa	= 2
		set mAB_total_cut_i_lt_dmesa	= 3
	else 
		set mAB_dA_total_u	= 20
		set mAB_dA_total_g	= 21
		set mAB_dA_total_r	= 22
		set mAB_dA_total_i	= 0
		set mAB_dA_total_z	= 24

		set cmAB_dA_total_u	= 28
		set cmAB_dA_total_g	= 29
		set cmAB_dA_total_r	= 30
		set cmAB_dA_total_i	= 31
		set cmAB_dA_total_z	= 32
		...
		set mAB_dA_total_cut_r_i	= 1
		set mAB_dA_total_cut_dmesa	= 2
		set mAB_dA_total_cut_i_lt_dmesa	= 3

	endif

else if ($tarsel_code_default =~ 'rpor'*) then
	...
	foreach ISNAP ($MYSNAPS)
		...
		foreach CATALOG ($key)
			...
			if ($SNAPNAME =~ *config* || $SNAPNAME =~ *idzred* || $SNAPNAME =~ *READ*) then
				...
				if ($SOFTLINK_CODE == CM)	echo 'box_size= 1071.93' >> $CONFIGFILE
				...
				echo 'obs_volume= '$obs_volume				>> $CONFIGFILE
